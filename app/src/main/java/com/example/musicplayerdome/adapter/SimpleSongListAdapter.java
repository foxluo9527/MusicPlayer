...
public class SimpleSongListAdapter extends BaseAdapter {
    private ArrayList<SongList> songLists;
    private Context context;
    public SimpleSongListAdapter(ArrayList<SongList> songLists, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ViewHolder holder;
        if (convertView==null){
            convertView= LayoutInflater.from(context).inflate(R.layout.add_to_songlist_item, parent, false);
