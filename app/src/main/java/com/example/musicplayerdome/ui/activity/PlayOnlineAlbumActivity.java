...
public class PlayOnlineAlbumActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected int getResId() {
        return R.layout.activity_play_online_album;
    }
    ...
    protected void onConfigView() {
        ...
        singerTv=findViewById(R.id.singer_text);
    }

    @Override
    protected void initData() {
        context=this;
        listId=getIntent().getLongExtra("albumId",-1);
        if (listId==-1){
            Toast.makeText(context,"无效的专辑列表id",Toast.LENGTH_SHORT).show();
            finish();
            return;
        }
        ...
        searchView.setOnCloseListener(new SearchView.OnCloseListener() {
            ...
            public boolean onClose() {
                ...
                adapter=new MusicListAdapter(playList.getMusics(),context,PlayOnlineAlbumActivity.this::onClick);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String s) {
                ...
                adapter=new MusicListAdapter(tempMusics,context,PlayOnlineAlbumActivity.this::onClick);
                listView.setAdapter(adapter);
    ...
    private void getPlayList(){
        ...
        new AsyncTask<Void,Void,Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                playList= HttpRequest.getAlbumDetails(listId);
                if (playList!=null)
                musicCount=playList.getMusics().size();
                return null;
            }
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                if (playList!=null){
                    ...
                    numTv.setText("("+musicCount+")");
                    singerTv.setText("创作者:"+playList.getSinger());
                    FragmentMine.setListViewHeightBasedOnChildren(listView);
                }else {
                    Toast.makeText(context,"未找到专辑信息",Toast.LENGTH_LONG).show();
                    finish();
                }
            }
        }.execute();
