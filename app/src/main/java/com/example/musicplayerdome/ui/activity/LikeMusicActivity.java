...
public class LikeMusicActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void initData() {
        ...
        numTv.setText("("+HomeActivity.likeSongList.getMusics().size()+")");
        adapter=new MusicListAdapter(HomeActivity.likeSongList.getMusics(),this,this::onClick);
    ...
    private void initListener(){
        searchView.setOnCloseListener(new SearchView.OnCloseListener() {
            ...
            public boolean onClose() {
                ...
                MusicDaoImpl.orderListMusicByDefault(HomeActivity.likeSongList);
                initOrderList();
                adapter=new MusicListAdapter(HomeActivity.likeSongList.getMusics(),LikeMusicActivity.this,LikeMusicActivity.this::onClick);
                listView.setAdapter(adapter);
                numTv.setText("("+HomeActivity.likeSongList.getMusics().size()+")");
                return false;
            }
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String s) {
                ...
                List<Music> musics=MusicDaoImpl.queryListMusic(HomeActivity.likeSongList,searchView.getQuery().toString());
                HomeActivity.likeSongList.getMusics().clear();
                HomeActivity.likeSongList.getMusics().addAll(musics);
                adapter=new MusicListAdapter(HomeActivity.likeSongList.getMusics(),LikeMusicActivity.this,LikeMusicActivity.this::onClick);
                listView.setAdapter(adapter);
                numTv.setText("("+HomeActivity.likeSongList.getMusics().size()+")");
                return false;
        ...
        listView.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                if (MusicService.mlastPlayer!=null
                        &&HomeActivity.musicControl.getMusic().getSId()==HomeActivity.likeSongList.getId()){
    ...
    private void initOrderList(){
        ...
        switch (order){
            case 0:
                ...
                break;
            case 1:
                MusicDaoImpl.orderListMusicByName(HomeActivity.likeSongList);
                break;
            case 2:
                MusicDaoImpl.orderListMusicBySinger(HomeActivity.likeSongList);
                break;
            case 3:
                MusicDaoImpl.orderListMusicByAlbum(HomeActivity.likeSongList);
                break;
        }
    }
    ...
    public void doClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.play_view:
                ...
                break;
            case R.id.list_view:
                showListPopupMenu(LikeMusicActivity.this);
                break;
            case R.id.show_music_view:
                Intent intent=new Intent(LikeMusicActivity.this,DetailsActivity.class);
                intent.putExtra("continuePlay",true);
                startActivity(intent);
                break;
            case R.id.back_play:
                long playId=HomeActivity.musicControl.getMusic().getId();
                for (int i=0;i<HomeActivity.likeSongList.getMusics().size();i++){
                    Music music=HomeActivity.likeSongList.getMusics().get(i);
            ...
            case R.id.play_all_view:
                Intent intent1=new Intent(LikeMusicActivity.this,DetailsActivity.class);
                MusicService.initPlayMsg(0, (ArrayList<Music>) HomeActivity.likeSongList.getMusics());
                adapter.notifyDataSetChanged();
                startActivity(intent1);
                break;
            case R.id.list_choice_view:
                Intent intent2=new Intent(LikeMusicActivity.this,MultipleMusicActivity.class);
                intent2.putExtra("listPosition",3);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.music_play_view:
                ...
                if (MusicService.mlastPlayer!=null
                        &&HomeActivity.musicControl.getMusic().getSId()==HomeActivity.likeSongList.getId()
                        &&HomeActivity.musicControl.getMusic().getId()==HomeActivity.likeSongList.getMusics().get(position).getId())
                    intent.putExtra("continuePlay",true);
                else
                    MusicService.initPlayMsg(position, (ArrayList<Music>) HomeActivity.likeSongList.getMusics());
                adapter.notifyDataSetChanged();
                startActivity(intent);
                break;
            case R.id.music_more_view:
                showMusicMorePopup(LikeMusicActivity.this,HomeActivity.likeSongList,position);
                break;
        }
    }
            ...
            switch (requestCode) {
                ...
                case UCrop.REQUEST_CROP:
                    if (resultCode == RESULT_OK) {
                        ...
                        if (nowPosition!=-1){
                            Music music=HomeActivity.likeSongList.getMusics().get(nowPosition);
                            int playIndex=MusicService.listMusic.indexOf(music);
                            music.setAlbumImg(coverString);
                            MusicDaoImpl.updateSongListMsg(HomeActivity.likeSongList);
                        ...
                        LocalSongActivity.refreshView(LikeMusicActivity.this,VAL_UPDATE_UI_PLAY);
                        nowPosition=-1;
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    if (!HomeActivity.musicControl.isPlaying()) {
                        playImg.setImageDrawable(LikeMusicActivity.this.getDrawable(R.drawable.play));
                        songImg.clearAnimation();
                    } else {
                        playImg.setImageDrawable(LikeMusicActivity.this.getDrawable(R.drawable.pause));
    ...
    private void showOrderPopup(){
        int order=HomeActivity.shared.getInt("orderBy",0);
        final View popView = View.inflate(LikeMusicActivity.this,R.layout.select_order_menu,null);
...
//        int height = getResources().getDisplayMetrics().heightPixels/2;
        ...
        popupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                LocalSongActivity.refreshView(LikeMusicActivity.this,VAL_UPDATE_UI_PLAY);
                WindowManager.LayoutParams lp = LikeMusicActivity.this.getWindow().getAttributes();
                lp.alpha = 1.0f;
                LikeMusicActivity.this.getWindow().setAttributes(lp);
            }
        });
    ...
    private void showListPopupMenu(Context context) {
        ...
        delAllView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog show;
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(LikeMusicActivity.this);
                View view=View.inflate(context, R.layout.sure_del_list, null);
                View sure,cancel;
                sure=view.findViewById(R.id.sure);
                cancel=view.findViewById(R.id.cancel);
