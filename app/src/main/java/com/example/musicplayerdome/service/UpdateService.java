...
import com.example.musicplayerdome.BuildConfig;
import com.example.musicplayerdome.R;

import java.io.File;

public class UpdateService extends Service {
    public static final String UpdateDownPath= Environment.getExternalStorageDirectory()+"/MusicPlayer/apk/MusicPlayer.apk";
    ...
    @Download.onTaskComplete void taskComplete(DownloadTask task) {
        ...
        if (task.getKey().equals(url)){
            ...
            Uri uri = FileProvider.getUriForFile(getApplicationContext(), "com.example.musicplayerdome.fileprovider", new File(UpdateDownPath));
            //安装程序
